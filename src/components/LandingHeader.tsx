...
export function LandingHeader() {
  return (
    <header className="fixed left-0 top-0 z-50 w-full px-4 pt-4 md:px-8 md:pt-6">
      <div className="mx-auto flex max-w-6xl items-center justify-between rounded-full border border-warm-border bg-warm-bg/85 px-4 py-3 shadow-[0_18px_60px_rgba(58,58,46,0.08)] backdrop-blur-xl md:px-5">
        <a
          href="#beranda"
        ...
        <a
          href="#mulai"
          className="rounded-full bg-warm-ink px-5 py-3 text-sm font-semibold text-warm-bg transition-transform hover:-translate-y-0.5 hover:bg-warm-accent focus:outline-none focus:ring-2 focus:ring-warm-accent focus:ring-offset-2 focus:ring-offset-warm-bg"
        >
          Mulai menulis
        </a>
      </div>
